(function(){
    ...
    const dict = {
        zh: {
            ...
            'api.saveFailed': '保存失败',
            'api.saving': '保存中...',
            'api.subtitle': '管理 API 平台、模型和应用版本更新。',
            'api.testingUrl': '验证中...',
            'api.testUrl': '验证地址',
            'api.title': '设置',
            'api.apiSectionTitle': 'API 设置',
            'api.versionSectionTitle': '版本',
        ...
        en: {
            ...
            'api.saving': 'Saving...',
            'api.subtitle': 'Manage API providers, models, and app version updates.',
            'api.testingUrl': 'Testing...',
            'api.testUrl': 'Test URL',
            'api.title': 'Settings',
            'api.apiSectionTitle': 'API Settings',
            'api.versionSectionTitle': 'Version',
